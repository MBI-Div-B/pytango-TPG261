...
Adapted for python3 by MBI div B
"""
...
class TPG26x(object):
    ...
    * RST: RS232 test
    ...
    def __init__(self, address='TCPIP0::netcom2.sxr.lab::2001::SOCKET'):
        ...
        # below
        self.con = pyvisa.ResourceManager().open_resource(address)
        self.con.write_termination = '\r\n'
        self.con.read_termination = '\r\n'
    ...
    def _send_command(self, command):
        ...
        :raises IOError: if the negative acknowledged or a unknown response
            is returned
        """
        response = self.con.query(command)
...
class TPG262(TPG26x):
    ...
    def __init__(self, address='TCPIP0::netcom2.sxr.lab::2001::SOCKET'):
        ...
        :type baudrate: int
        """
        super(TPG262, self).__init__(address=address)
...
class TPG261(TPG26x):
    ...
    def __init__(self, address="TCPIP0::netcom2.sxr.lab::2001::SOCKET"):
        ...
        :type baudrate: int
        """
        super(TPG261, self).__init__(address=address)
